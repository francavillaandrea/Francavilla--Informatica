    ...
    public partial class FrmMain : Form
    {
        ...
        private void caricaCombo()
        {
            for(int i=0; i< int_materie.Length; i++)
                cmbMaterie.Items.Add(int_materie[i]);
        ...
        private void btnCalcolaMediaMat_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("LA MEDIA E' " + media.ToString("F2"), 
                            "MEDIA " + materia, 
                            MessageBoxButtons.OK,z
