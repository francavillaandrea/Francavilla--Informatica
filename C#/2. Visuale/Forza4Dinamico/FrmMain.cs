...
namespace Forza4Dinamico
{
    public partial class FrmMain : Form
    {
        ...
        private void btnColonna_Click(object sender, EventArgs e)
        {
            ...
            if(controlloVittoria(m, posI, posJ, giocatore))
            {
            ...
            else
            {
                ...
                this.Controls["lblGiocatore"].Text =
                                "Turno Giocatore: " + giocatore.ToString();
            }
        }
        ...
        {
            string nomeBtn = "btn_" +
                                posI.ToString() + "_" + posJ.ToString();
            Button btn = (Button)this.Controls[nomeBtn];

            btn.BackColor = (giocatore == 1) ? Color.Red : Color.Yellow;
        ...
        private void btnGioca_Click(object sender, EventArgs e)
        {
            ...
            lbl.Text = "Turno Giocatore: " + giocatore.ToString(); 
