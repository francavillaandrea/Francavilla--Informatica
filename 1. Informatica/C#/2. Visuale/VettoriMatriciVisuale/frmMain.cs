...
namespace VettoriMatriciVisuale
{
    public partial class frmMain : Form
    {
        ...
        private void btnCaricaMatrice_Click(object sender, EventArgs e)
        {
            ...
            m = new int[r, c];
            settaDGV(dgvC, r, c);
            clsMatrici.CaricaMatrice(m, 1, 1);
        ...
        private void btnColoraTriangoliDP_Click(object sender, EventArgs e)
        {
            clsMatrici.coloraTriangoliDP(m, dgvC);
        }

        private void btnColoraTriangoliDS_Click(object sender, EventArgs e)
        {
            clsMatrici.coloraTriangoliDS(m, dgvC);
        }

        private void btnColoraRighe_Click(object sender, EventArgs e)
        {
            clsMatrici.coloraRighe(m, dgvC);
        }

        private void btnColoraColonne_Click(object sender, EventArgs e)
        {
            clsMatrici.coloraColonne(m,dgvC);
        }

        private void btnColoraRigheSopraDP_Click(object sender, EventArgs e)
        {
            clsMatrici.coloraRigheSopraDP(m,dgvC);
        }
    }
}
